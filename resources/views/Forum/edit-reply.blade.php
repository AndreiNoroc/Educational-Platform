            ...
            <div class="card-body">
                ...
                <form action="/forum/{{$reply->id}}/update-replies" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="username" placeholder="username" value="{{$reply->username}}">
                    </div>
                    <div class="form-group">
                        <textarea name="text" placeholder="text" cols="5" rows="5" class="form-control">{{$reply->text}}</textarea>
                    </div>
