...
<body style="background: white">
   ...
   <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="../index.php">CumSaFaciBani</a></h1>
  ...
  <section style="background: white">
    <div id="buttons" class="container-fluid h-100" style="color: black;">

      <div class="d-flex flex-row justify-content-around w-100 h-auto" style="height: 40%;">
        <div class="col justify-content-start w-25 h-100 shadow p-3 bg-white rounded">

          <div class="h-10 w-100 d-inline-block my-3">
            <div class="d-flex align-items-center h-100">
              <div class="text-center w-100">
                <h5 class="card-title">Easy Category</h5>
              </div>
            </div>
          </div>
          ...
          <div class="h-10 w-100 d-inline-block my-3">
              <div class="d-flex align-items-center h-100">
                <div class="text-center w-100">
                  <a href="#firstgame">
                    <button id="startfgame" type="button" class="btn btn-dark btn-lg" onclick="choosefirstgame()">First demo game</button>
                  </a>
                </div>
              </div>
          </div>
          ...
          <div class="h-10 w-100 d-inline-block my-3">
            <div class="d-flex align-items-center h-100">
              <div class="text-center w-100">
                <a href="#chosengame">
                  <button id="startsgame" type="button" class="btn btn-dark btn-lg" onclick="choosesecondgame()">Second demo game</button>
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="h-10 w-100 d-inline-block my-3">
            <div class="d-flex align-items-center h-100">
              <div class="text-center w-100">
                <button type="button" class="btn btn-dark btn-lg" onclick="">Third demo game</button>
              </div>
            </div>
          </div>
        ...
        <div class="col justify-content-start mx-3 w-25 h-100 shadow p-3 bg-white rounded">

          <div class="h-10 w-100 d-inline-block my-3">
            <div class="d-flex align-items-center h-100">
              <div class="text-center w-100">
                <h5 class="card-title">Medium Category</h5>
              </div>
            </div>
          </div>
          ...
          <div class="h-10 w-100 d-inline-block my-3">
            <div class="d-flex align-items-center h-100">
              <div class="text-center w-100">
                <button type="button" class="btn btn-dark btn-lg" onclick="">First demo game</button>
              </div>
            </div>
          </div>
          ...
          <div class="h-10 w-100 d-inline-block my-3">
            <div class="d-flex align-items-center h-100">
              <div class="text-center w-100">
                <button type="button" class="btn btn-dark btn-lg" onclick="">Second demo game</button>
              </div>
            </div>
          </div>
        ...
        <div class="col justify-content-start w-25 h-100 shadow p-3 bg-white rounded">
          ...
          <div class="h-10 w-100 d-inline-block my-3">
            <div class="d-flex align-items-center h-100">
              <div class="text-center w-100">
                <h5 class="card-title">Hard Category</h5>
              </div>
            </div>
          </div>
...
<!--d-flex align-items-center-->
  ...
  <script src="../assets/js/firstdemogame.js"></script>
